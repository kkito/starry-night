...
import { CANVAS_MARGIN } from '../../lib/draw-sky';
import { toLocalInput, type ViewParams } from '../../shared/view-params';
import { StarChart } from '../../components/StarChart';
import { SkyCanvas3D } from '../../components/SkyCanvas3D';
    ...
    <Page>
      {sky.error ? (
        ...
        <>
          ...
          {view.viewMode === '3d' ? (
            // 3D 档统一走 SkyCanvas3D（canvas 2d，绘制经 sky-core drawSkyScene，与 web 同源；
            // 手势状态机在组件内，页面只传 props。旧 three 分支 Sky3DAdapter/Sky3D 已删除）。
            <SkyCanvas3D
              stars={sky.drawStars}
              track={track}
